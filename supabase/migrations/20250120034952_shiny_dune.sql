...
DROP POLICY IF EXISTS "available_apps_view_policy" ON available_apps;
DROP POLICY IF EXISTS "available_apps_modify_policy" ON available_apps;
DROP POLICY IF EXISTS "organization_apps_view_policy" ON organization_apps;
DROP POLICY IF EXISTS "organization_apps_modify_policy" ON organization_apps;

-- Check if app_type enum exists and create if it doesn't
DO $$ 
BEGIN
