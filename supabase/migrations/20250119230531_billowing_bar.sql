...
-- Create scope enum type if it doesn't exist
DO $$ BEGIN
...
DROP TRIGGER IF EXISTS validate_link_scope ON links;
...
DROP POLICY IF EXISTS "Global admins can manage all links" ON links;
DROP POLICY IF EXISTS "Organization admins can manage org links" ON links;
