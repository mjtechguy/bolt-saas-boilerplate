...
DROP POLICY IF EXISTS "direct_teams_access" ON teams;
DROP POLICY IF EXISTS "direct_user_teams_access" ON user_teams;
DROP POLICY IF EXISTS "direct_links_access" ON links;
...
-- Create optimized indexes with IF NOT EXISTS
