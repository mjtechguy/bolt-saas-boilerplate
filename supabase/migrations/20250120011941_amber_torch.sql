/*
  # Update AI Settings Token Management
  
  1. Changes
    - Drop existing function to avoid return type conflicts
    - Remove context_size column
...
-- Remove context_size column and add token management columns
ALTER TABLE organization_ai_settings 
DROP COLUMN IF EXISTS context_size,
